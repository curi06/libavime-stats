        ...
        >
          <div className="bg-gradient-to-r from-blue-950 to-blue-900 px-4 py-3">
            <div className="flex items-center justify-center gap-3">
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-black leading-tight text-white">
                {equipo.nombre}
              </h3>
            </div>
          </div>
              ...
              equipo.jugadoresDestacados.map((jugador: any, index: number) => {
                ...
                return (
                  <Link
                    ...
                    className="block"
                  >
                    <div className="relative rounded-xl border border-slate-200 bg-slate-50 p-3 sm:p-3.5 transition hover:bg-white hover:shadow-sm">
                      ...
                      <div className="flex items-center gap-3 sm:gap-4 pl-1">
                        <div className="relative h-[70px] w-[70px] sm:h-[82px] sm:w-[82px] shrink-0 overflow-hidden rounded-full border-4 border-white bg-slate-200 shadow-md">
                          <Image
                            src={fotoJugador}
                          ...
                          />
                          {index === 0 && (
                            <span className="absolute bottom-0 right-0 flex h-5 w-5 items-center justify-center rounded-full bg-yellow-400 text-[10px] shadow">
                              ⭐
                            </span>
                          )}
                        </div>
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <h4 className="mt-0.5 truncate text-base sm:text-lg font-black leading-tight text-slate-900">
                            {jugador.nombre}
                          </h4>

                          <div className="mt-2 grid grid-cols-3 gap-1.5 sm:gap-2">
                            <div className="rounded-lg bg-blue-50 px-1 py-1.5 text-center">
                              <p className="text-[9px] font-black text-blue-600">PTS</p>
                            ...
                            <div className="rounded-lg bg-green-50 px-1 py-1.5 text-center">
                              <p className="text-[9px] font-black text-green-600">REB</p>
                              <p className="text-sm sm:text-base font-black text-green-950">
                                {Number(jugador.rpg || 0).toFixed(1)}
                              </p>
                            </div>
                            <div className="rounded-lg bg-orange-50 px-1 py-1.5 text-center">
                              <p className="text-[9px] font-black text-orange-600">AST</p>
                              <p className="text-sm sm:text-base font-black text-orange-950">
