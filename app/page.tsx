...
const jugadoresConEstadisticas =
  ...
  const totalPuntos = jugadores.reduce(
    (total, jugador) => total + Number(jugador.ppg ?? 0),
    0
  );
  ...
  const proximosPartidos = [...partidosActuales]
    .filter(
      (partido) =>
        partido.estado !== "Finalizado" ||
        partido.puntosLocal === null ||
